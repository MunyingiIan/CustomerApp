...
import com.ellixar.app.customer.sembe.customerapp.SendActivity;
...
public class AccountActivityBusinessesRecylerViewAdapter extends RecyclerView.Adapter<AccountActivityBusinessesRecylerViewAdapter.UserViewHolder> {

    private List<Users> usersList;
    private Context context;

    public AccountActivityBusinessesRecylerViewAdapter(List<Users> usersList, Context context) {
